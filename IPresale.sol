...
interface IPresale {
    ...
    /**
     * @dev Emitted when a participant attempts to claim tokens without having contributed.
     */
    error WithdrawExceed();
    ...
    /**
     * @dev Emitted when a participant withdraws their tokens from the presale.
     * @param user Address of the participant who is withdrawing their tokens.
